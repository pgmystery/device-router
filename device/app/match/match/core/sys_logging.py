...
class Logger:
	def __init__(self):
		...
		handler = logging.handlers.TimedRotatingFileHandler(self.LOG_FILENAME, when=self.LOGGING_FILE_TIME, backupCount=self.LOG_BACKUP_COUNTS)
	...
	def load_settings(self):
		self.settings = Settings.get_setting_options(path(), "logger")
		if self.settings:
		# log_path:
